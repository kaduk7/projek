...
function Delete({ zonaId, reload }: { zonaId: Number, reload: Function }) {
    ...
    const handleDelete = async (zonaId: number) => {
        setIsLoading(true)
        handleClose()
        ...
        <div>
            ...
            <Modal
                ...
                <Modal.Footer>
                    ...
                    <button type="button" className="btn btn-danger light" onClick={() => handleDelete(Number(zonaId))}>Ya, Hapus</button>
                </Modal.Footer>
            </Modal>
        </div>
    )
